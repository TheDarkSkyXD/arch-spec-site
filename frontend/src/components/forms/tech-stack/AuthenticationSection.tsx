...
const AuthenticationSection = ({
  ...
  useEffect(() => {
    ...
    console.log('Checking initial data for authentication section:', initialData);
    ...
    if (initialData.authentication.provider) {
      ...
      console.log('Setting initial auth provider:', initialData.authentication.provider);
      valuesWereSet = true;
    }

    // Check and set auth methods
    if (initialData.authentication.methods && initialData.authentication.methods.length > 0) {
