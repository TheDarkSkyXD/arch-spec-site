...
const StorageSection = ({
  ...
  useEffect(() => {
    ...
    console.log('Checking initial data for storage section:', initialData.storage);
    ...
    if (initialData.storage.service) {
      ...
      console.log('Setting initial storage service:', initialData.storage.service);
      valuesWereSet = true;
    }
  ...
  return (
    <div>
      <h3 className="mb-4 text-lg font-medium text-slate-800 dark:text-slate-100">Storage</h3>
