...
export default function ImplementationPromptsForm({
  ...
  const generateAIPrompts = async () => {
    ...
    try {
      ...
      IMPLEMENTATION_CATEGORIES.forEach((category) => {
        placeholderPrompts[category] = [
          {
            id: crypto.randomUUID(),
            content: `This is a placeholder for the main prompt for ${CATEGORY_LABELS[category]}. In a real implementation, this would be generated by an AI based on project requirements, business goals, and tech stack.`,
          ...
          {
            id: crypto.randomUUID(),
            content: `This is a placeholder for the first follow-up prompt for ${CATEGORY_LABELS[category]}. Use this if the main prompt doesn't complete the task.`,
          ...
          {
            id: crypto.randomUUID(),
            content: `This is a placeholder for the second follow-up prompt for ${CATEGORY_LABELS[category]}. Use this as a last resort if the previous prompts didn't work.`,
      ...
      showToast({
        title: "Success",
        description: "Placeholder prompts generated successfully",
        type: "success",
      });
    } catch (error) {
    ...
    >
      ...
      <div className="flex justify-end items-center gap-3 mb-4">
        ...
        <Button
          ...
          disabled={isGenerating || !projectId || !hasAIFeatures}
          ...
          title={
            hasAIFeatures
              ? "Generate prompts based on project specification"
