...
describe("RequirementsForm", () => {
  ...
  test("adds and removes functional requirements", async () => {
    ...
    const functionalInput = screen.getByPlaceholderText(
      "Enter a functional requirement"
    );
  ...
  test("adds and removes non-functional requirements", async () => {
    ...
    const nonFunctionalInput = screen.getByPlaceholderText(
      "Enter a non-functional requirement"
    );
