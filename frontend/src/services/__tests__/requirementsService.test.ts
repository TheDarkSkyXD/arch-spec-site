...
describe('requirementsService', () => {
  ...
  describe('getRequirements', () => {
    it('should fetch requirements successfully', async () => {
      ...
      expect(apiClient.get).toHaveBeenCalledWith('/api/project-specs/project-123/requirements');
  ...
  describe('saveRequirements', () => {
    it('should save requirements successfully', async () => {
      ...
      const result = await requirementsService.saveRequirements('project-123', requirementsData);

      expect(apiClient.put).toHaveBeenCalledWith('/api/project-specs/project-123/requirements', {
        functional: ['User authentication', 'Dashboard view'],
        non_functional: ['Performance', 'Security'],
      });
