...
describe("UIDesignService", () => {
  ...
  describe("getUIDesign", () => {
    it("should fetch UI design data successfully", async () => {
      ...
      expect(apiClient.get).toHaveBeenCalledWith(
        "/api/project-specs/test-project-id/ui-design"
      );
    ...
    it("should throw an error when API fails", async () => {
      ...
      await expect(UIDesignService.getUIDesign(mockProjectId)).rejects.toThrow(
        "API Error"
      );
      expect(apiClient.get).toHaveBeenCalledWith(
        "/api/project-specs/test-project-id/ui-design"
  ...
  describe("saveUIDesign", () => {
    it("should save UI design data successfully", async () => {
      ...
      // Call the service
      const result = await UIDesignService.saveUIDesign(
        mockProjectId,
        mockUIDesignData
      );
    ...
    it("should throw an error when API fails", async () => {
      ...
      // Call the service and expect it to throw
      await expect(
        UIDesignService.saveUIDesign(mockProjectId, mockUIDesignData)
