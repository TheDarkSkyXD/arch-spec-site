...
class FirebaseSettings(BaseSettings):
    ...
    auth_provider_x509_cert_url: str = Field("https://www.googleapis.com/oauth2/v1/certs", env="FIREBASE_AUTH_PROVIDER_X509_CERT_URL")
...
def get_settings():
    ...
    if settings.firebase.storage_bucket:
        settings = settings.model_copy(update={"firebase_storage_bucket": settings.firebase.storage_bucket})
    return settings
