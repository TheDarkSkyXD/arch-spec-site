...
TECH_STACK_DATA = {
    ...
    "categories": {
        ...
        "backend": {
            ...
            "baas": ["Supabase", "Firebase", "AWS Amplify", "Appwrite"],
            "serverless": [
                "AWS Lambda",
                "Azure Functions",
        ...
        "database": {
            ...
            "clients": ["Redis Node.js client", "ioredis"],
        },
        "authentication": {
            "providers": [
                "JWT",
        ...
        "deployment": {
            ...
            "containerization": ["Docker", "Kubernetes", "AWS ECS", "GCP Cloud Run"],
            "ci_cd": ["GitHub Actions", "GitLab CI", "CircleCI", "Jenkins", "Travis CI"],
        },
        "storage": {
            "objectStorage": [
                "AWS S3",
            ...
            "fileSystem": ["Local File System", "Network File System", "Self-hosted"],
        },
        "hosting": {
            "frontend": ["Vercel", "Netlify", "AWS Amplify", "Azure App Service", "Self-hosted"],
            "backend": [
                "Self-hosted",
                "AWS Lambda",
                "Azure Functions",
        ...
        "testing": {
            ...
            "e2eTesting": ["Cypress", "Playwright", "Selenium", "Puppeteer", "TestCafe"],
            "apiTesting": ["Postman", "REST Assured", "SuperTest", "Pactum"],
        },
    },
    ...
    "technologies": {
        ...
        "stateManagement": {
            ...
            "NgRx": {"description": "Reactive State for Angular", "compatibleWith": ["Angular"]},
            "Akita": {
        ...
        "routing": {
            ...
            "Preact Router": {"description": "URL router for Preact", "compatibleWith": ["Preact"]},
            "Vaadin Router": {
                "description": "A small, powerful and framework-agnostic client-side router",
                "compatibleWith": ["Lit"],
            },
            "Lit Router": {"description": "Router for Lit applications", "compatibleWith": ["Lit"]},
        },
        # API Clients
        "apiClients": {
            "Axios": {
            ...
            "Vue Query": {"description": "TanStack Query for Vue", "compatibleWith": ["Vue.js"]},
            "Angular HttpClient": {
        ...
        "metaFrameworks": {
            ...
            "Nuxt.js": {"description": "The intuitive Vue framework", "compatibleWith": ["Vue.js"]},
            "Vite": {
        ...
        "orms": {
            ...
            "MongoDB PyMongo": {
                ...
                "compatibleWith": {"databases": ["MongoDB"], "frameworks": ["Flask", "FastAPI"]},
            },
            "Hibernate": {
            ...
            "Spring Data MongoDB": {
                ...
                "compatibleWith": {"databases": ["MongoDB"], "frameworks": ["Spring Boot"]},
            },
            "AWS SDK": {
        ...
        "auth": {
            ...
            "Passport.js": {
                ...
                "compatibleWith": {"frameworks": ["Express.js", "NestJS", "Custom Express"]},
            },
            "Auth0": {
        ...
        "testing": {
            ...
            "Jasmine": {
                ...
                "compatibleWith": {"frameworks": ["Angular"]},
            },
            "pytest": {
                "type": "unitTesting",
                "description": "Testing framework for Python",
                "compatibleWith": {"frameworks": ["Django", "Flask", "FastAPI"]},
            },
            "JUnit": {
                "type": "unitTesting",
            ...
            "RSpec": {
                ...
                "compatibleWith": {"frameworks": ["Ruby on Rails"]},
            },
            "Cypress": {
                "type": "e2eTesting",
            ...
            "Selenium": {
                ...
                "compatibleWith": {"frameworks": ["React", "Angular", "Vue.js"]},
            },
            "Puppeteer": {
                "type": "e2eTesting",
                "description": "Node.js library for controlling Chrome or Chromium",
                "compatibleWith": {"frameworks": ["React", "Vue.js", "Angular", "Next.js"]},
            },
            "TestCafe": {
                "type": "e2eTesting",
                "description": "A Node.js tool to automate end-to-end web testing",
                "compatibleWith": {"frameworks": ["React", "Vue.js", "Angular"]},
            },
            "Postman": {
                "type": "apiTesting",
        ...
        "serverless": {
            ...
            "Cloudflare Workers": {
                "type": "functions",
                "description": "Serverless execution environment on Cloudflare's edge network",
                "compatibleWith": {"frameworks": ["Express.js", "Custom Express", "Serverless"]},
            },
            "Appwrite Functions": {
                "type": "functions",
