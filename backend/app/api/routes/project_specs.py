...
async def update_requirements_spec(
    update_data: RequirementsSpecUpdate = Body(..., description="The requirements spec update data"),
    project_id: str = Path(..., description="The project ID"),
    database: AsyncIOMotorDatabase = Depends(get_db),
    current_user: Dict[str, Any] = Depends(get_current_user)
):
...
add_spec_routes(
    "pages", "pages", PagesSpec, PagesSpecUpdate,
...
add_spec_routes(
    "data_model", "data-model", DataModelSpec, DataModelSpecUpdate,
...
add_spec_routes(
    "testing", "testing", TestingSpec, TestingSpecUpdate,
...
add_spec_routes(
    "project_structure", "project-structure", ProjectStructureSpec, ProjectStructureSpecUpdate,
...
add_spec_routes(
    "deployment", "deployment", DeploymentSpec, DeploymentSpecUpdate,
...
add_spec_routes(
    "documentation", "documentation", DocumentationSpec, DocumentationSpecUpdate,
