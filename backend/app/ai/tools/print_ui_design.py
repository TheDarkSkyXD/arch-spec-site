                  ...
                  "properties": {
                      "colors": {
                          ...
                          "properties": {
                              ...
                              "accent": {"type": "string", "description": "Accent color for highlights"},
                              "background": {"type": "string", "description": "Main background color"},
                              ...
                              "info": {"type": "string", "description": "Information state color"},
                              "surface": {"type": "string", "description": "Surface elements color"},
                              "border": {"type": "string", "description": "Border color"}
                          },
                          "required": ["primary", "secondary", "accent", "background", "textPrimary", "textSecondary"]
                      },
                      "typography": {
                          "type": "object",
                          ...
                          "properties": {
                              ...
                              "fontWeight": {"type": "integer", "description": "Base font weight"},
                              "headingSizes": {
                                  "type": "object",
                      ...
                      "borderRadius": {
                          ...
                          "properties": {
                              ...
                              "xl": {"type": "string", "description": "Extra large border radius"},
                              "pill": {"type": "string", "description": "Pill-shaped border radius"}
                          },
                      ...
                      "layout": {
                          ...
                          "properties": {
                              "containerWidth": {"type": "string", "description": "Maximum width of the content container"},
                              "responsive": {"type": "boolean", "description": "Whether the design is responsive"},
                              "sidebarWidth": {"type": "string", "description": "Width of the sidebar if applicable"},
                              "topbarHeight": {"type": "string", "description": "Height of the top navigation bar"},
                              "gridColumns": {"type": "integer", "description": "Number of columns in the grid system"},
                              "gutterWidth": {"type": "string", "description": "Width of gutters between grid columns"}
                          },
                      ...
                      "components": {
                          ...
                          "properties": {
                              "buttonStyle": {"type": "string", "description": "General button styling approach"},
                              "inputStyle": {"type": "string", "description": "General input styling approach"},
                              "cardStyle": {"type": "string", "description": "General card styling approach"},
                              "tableStyle": {"type": "string", "description": "General table styling approach"},
                              "navStyle": {"type": "string", "description": "General navigation styling approach"}
                          },
                      ...
                      "darkMode": {
                          ...
                          "properties": {
                              "enabled": {"type": "boolean", "description": "Whether dark mode is supported"},
                              "colors": {
                                  "type": "object",
                                  "description": "Dark mode specific colors",
                                  "properties": {
                                      "background": {"type": "string", "description": "Dark mode background color"},
                                      "textPrimary": {"type": "string", "description": "Dark mode primary text color"},
                                      "textSecondary": {"type": "string", "description": "Dark mode secondary text color"},
                                      "surface": {"type": "string", "description": "Dark mode surface elements color"},
                                      "border": {"type": "string", "description": "Dark mode border color"}
                                  },
                      ...
                      "animations": {
                          ...
                          "properties": {
                              "transitionDuration": {"type": "string", "description": "Default transition duration"},
                              "transitionTiming": {"type": "string", "description": "Default transition timing function"},
                              "hoverScale": {"type": "number", "description": "Scale factor for hover effects"},
                              "enableAnimations": {"type": "boolean", "description": "Whether animations are enabled by default"}
                          },
                          "required": ["transitionDuration", "enableAnimations"]
                      }
                  },
                  "required": ["colors", "typography", "spacing", "borderRadius", "layout", "components"]
              }
          },
          "required": ["data"]
      },
